...
id3 = tree.DecisionTreeClassifier()                               # create decision tree model
id3.fit(features, target_column)                                  # fit model to data

cv_scores = cross_val_score(id3, features, target_column, cv=5)    # compute 5-fold cross-validation scores
print(cv_scores)
